<?php
		...
		isset($_POST['assigndetail']))
	{
		...
		if ($assigntitle == "" || $duedate == "" || $assigntext == "")
		{
			...
			$connection->close();
			header("Location: http://fineshare-gsathya28679192.codeanyapp.com/FineShare/insidebox/newassign.php");
			exit();
		}
	...
	{
		header("Location: http://localhost:9080/FineShare/insidebox/newassign.php");
	}
